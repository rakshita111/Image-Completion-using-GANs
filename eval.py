...
def main():
  # real_names = list(glob.glob(glob.escape('{}\\*_orig.png'.format(args.resume))))
  # fake_names = list(glob.glob(glob.escape('{}\\*_comp.png'.format(args.resume))))
  # real_names.sort()
  # fake_names.sort()
  # print(real_names)
  # print(fake_names)

  # metrics for image assesments
  ...
  for img in glob.glob("D:/Thesis/PEN-Net-for-Inpainting-pytorch/orig/*.png"):
    im1 = cv2.imread(img)
    real_images.append(im1)
  for img1 in glob.glob("D:/Thesis/PEN-Net-for-Inpainting-pytorch/g3/*.png"):
    im2 = cv2.imread(img1)
    fake_images.append(im2)
